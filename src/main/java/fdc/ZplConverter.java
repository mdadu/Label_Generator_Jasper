...
/**
 * This class convertes base64png to zpl.
 *
...
public class ZplConverter {
  ...
  /**
   * Static method to convert base64string to zpl.
   *
   * @param image : points to the base64png image.
   * @return : ZPL string
   * @throws IOException : If bufferedImage not accessible.
   */
